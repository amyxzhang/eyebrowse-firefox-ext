...
*/
function handleIdleMsg(message) {
    var type = message.type;
    var event_type;
...
function setPromptMod(args) {
    var m = pageMod.PageMod({
        ...
        onAttach: function(worker) {
            ...
            worker.port.on("promptRes", function(message) {
...
function setIdleMod(args) {
    var m = pageMod.PageMod({
        ...
        onAttach: function(worker, args) {
            ...
            worker.port.on("idle", function(message) {
                console.log("IDLE:::", message)
                var message = JSON.parse(message);
                handleIdleMsg(message);
            });
        },
    });
    return m
